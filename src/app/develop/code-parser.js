...
function peg$parse(input, options) {
  ...
  var peg$startRuleFunctions = { JS: peg$parseJS };
  var peg$startRuleFunction = peg$parseJS;
  ...
  var peg$e0 = peg$literalExpectation("of(", false);
  ...
  var peg$e15 = peg$classExpectation(["'", "\"", "\\", "/", "b", "f", "n", "r", "t"], false, false);
  var peg$e16 = peg$literalExpectation("\\u", false);
  var peg$e17 = peg$classExpectation([["0", "9"], ["a", "f"], ["A", "F"]], false, false);
  ...
  var peg$e35 = peg$classExpectation([["0", "9"], ["a", "z"], ["A", "Z"], "$", "_"], false, false);
  ...
  var peg$f2 = function(c1, args, c3, c2, body) {
  return {type:'arrow', args: args, body: body, comments: c1.concat(c2, c3)};
};
  var peg$f3 = function(name, c1, args, c2, c3) {
  ...
  var peg$f8 = function() { return {type: 'object', value: {}}; };
  ...
  var peg$f11 = function() { return {type: 'Array', value: []}; };
  ...
  var peg$f14 = function(string) {
  	return {type: 'string', value: string.join('')};
  };
  var peg$f15 = function(character) {
    switch (character) {
      case "'":
      case '"':
      case '\\':
  ...
  var peg$f16 = function(codePoint) {
    return String.fromCodePoint(parseInt(codePoint.join(''), 16));
  };
  var peg$f17 = function() {
    return {type: 'number', value: parseFloat(text())};
};
  var peg$f18 = function() { return {type: 'boolean', value: true}; };
  var peg$f19 = function() { return {type: 'boolean', value: false}; };
  var peg$f20 = function() { return [] };
  var peg$f21 = function(comment) { return comment.join(''); };
  var peg$f22 = function(char) { return char; };
  var peg$f23 = function(comment) { return comment.join(''); };
  var peg$f24 = function(char) { return char; };
  var peg$f25 = function(chars) { return {type: 'name', value: chars.join('')}; };
  var peg$currPos = 0;
  var peg$savedPos = 0;
  ...
  function peg$parseObservableValue() {
  ...
  function peg$parseNameArguments() {
  ...
  function peg$parseString() {
    ...
    s0 = peg$parseSingleString();
    if (s0 === peg$FAILED) {
      s0 = peg$parseDoubleString();
    }
  ...
  function peg$parsesingle_line_char() {
    var s0, s1, s2;
  ...
  function peg$parsemulti_line_char() {
    var s0, s1, s2;
